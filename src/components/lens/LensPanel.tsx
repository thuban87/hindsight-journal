...
type SortOption = 'date-newest' | 'date-oldest' | 'quality-high' | 'quality-low' | 'wordcount-high' | 'wordcount-low';

function sortEntries(entries: JournalEntry[], sort: SortOption): JournalEntry[] {
